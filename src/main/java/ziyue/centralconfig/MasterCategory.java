...
public class MasterCategory extends ModuleCategory
{
     ...
     */
    public MasterCategory(String modId, Supplier<Text> titleSupplier, BiConsumer<ConfigEntryBuilder, ConfigCategory> categorySupplier, Supplier<ConfigBuilder> configBuilderSupplier) {
