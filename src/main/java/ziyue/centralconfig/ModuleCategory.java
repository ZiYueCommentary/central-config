...
public class ModuleCategory
{
    ...
    protected final Supplier<Text> titleSupplier;
     ...
     */
    public ModuleCategory(String modId, Supplier<Text> titleSupplier, BiConsumer<ConfigEntryBuilder, ConfigCategory> categoryBiConsumer) {
        this.modId = modId;
